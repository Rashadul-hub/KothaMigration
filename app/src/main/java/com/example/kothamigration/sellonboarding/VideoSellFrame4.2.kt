...
@Composable
fun UploadedVideo(onNextClicked: () -> Unit) {
            ...
            LazyColumn(
                ...
                item {
                    Box(
                        ...
                        // Body Section
                        UploadedVideoContent(dimensions,onNextClicked)
                    }
                }
            }
        } else {
...
@Composable
fun UploadedVideoContent(dimensions: Dimensions,onNextClicked: () -> Unit) {
    ...
    Column(
        ...
        UploadingTextContents(dimensions)
        ...
        UploadingNextButton(onNextClicked)
...
fun FileUpload() {
    ...
    Column(
        ...
        FileUploadComponent(
            ...
            status = FileUploadStatus.UPLOADED, ///Select Any variation
...
@Composable
fun UploadingNextButton(onNextClicked: () -> Unit) {
...
@Composable
fun UploadingTextContents(dimensions: Dimensions) {
    ...
    ReusableText(
        text = "It may take a while, please be patient ",

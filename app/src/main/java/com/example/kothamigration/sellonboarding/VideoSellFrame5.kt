...
@Composable
fun UploadingPreviewScreen(onNextClicked: () -> Unit) {
            ...
            LazyColumn(
                ...
                item {
                    Box(
                        ...
                        // Body Section
                        UploadingPreviewScreenContent(dimensions,onNextClicked)
                    }
                }
            }
        } else {
...
@Composable
fun UploadingPreviewScreenContent(dimensions: Dimensions,onNextClicked: () -> Unit) {
...
//        Spacer(modifier = Modifier.height(dimensions.large))
        ...
        SellFrame5TextContents(dimensions)
        ...
        //Button
        SellFrame5Button(onNextClicked)
...
fun ErrorFileUpload() {
    ...
    Column(
        ...
        FileUploadComponent(
            ...
            status = FileUploadStatus.ERROR, ///Select Any variation
...
fun FileUploadOptional() {
    ...
    Column(
        ...
        FileUploadComponent(
            ...
            buttonText = "Select File",
            status = FileUploadStatus.UPLOADING, ///Select Any variation
            caption = "Custom thumbnail (Optional)",
            modifier = Modifier.align(CenterHorizontally) // Center horizontally
...
@Composable
fun SellFrame5Button(onNextClicked: () -> Unit) {
...
@Composable
fun SellFrame5TextContents(dimensions: Dimensions) {
    ...
    ReusableText(
        text = "Upload short Preview video, it will be shown in post.",
...
@Preview
@Composable
fun UploadingPreviewScreenView() {
